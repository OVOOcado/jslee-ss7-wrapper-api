 ...
 */
public interface ForwardShortMessageRequestEventWrapper extends MapArgumentEventWrapper<ForwardShortMessageRequestWrapper> {
    
    /* (non-Javadoc)
     * @see pl.ovoo.jslee.ss7.wrapper.map.event.MapArgumentEventWrapper#getArgument()
     */
    ForwardShortMessageRequestWrapper getArgument();
}
